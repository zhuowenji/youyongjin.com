...
class AscProcessListRequest
{
	...
	public function setJdIntervene($jdIntervene){
		$this->jdIntervene = $jdIntervene;
         $this->apiParas["jdIntervene"] = $jdIntervene;
	}

	public function getJdIntervene(){
	  return $this->jdIntervene;
	}
